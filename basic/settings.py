...
# Read from environment; fallback only for local development
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'telusko'),
        'USER': os.getenv('DB_USER', 'postgres'),
        'PASSWORD': os.getenv('DB_PASSWORD', '1590'),
...
STATIC_URL = '/static/'
# Project-level static directory (where your repository's `static/` folder lives)
STATICFILES_DIRS = [
